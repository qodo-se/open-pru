...
function getmakefilePruPostBuildSteps(cpu, board)
{
    return  [
        ...
        "$(CAT) ${OPEN_PRU_PATH}/mcu_plus_sdk/source/pru_io/firmware/pru_load_bin_copyright.h pru_i2s_pru0_array.h > ${OPEN_PRU_PATH}/source/pru_i2s/firmware/I2S/pru_i2s_pru0_array.h;"+ 
...
function getccsPruPostBuildSteps(cpu, board)
{
    return  [
        "$(CG_TOOL_ROOT)/bin/hexpru --diag_wrap=off --array --array:name_prefix=pru_prupru_i2s0_image_0 -o pru_i2s_pru0_array.h  pru_i2s_pru0_array_" + board + "_" + cpu + "_fw_ti-pru-cgt.out;"+ 
        "if ${CCS_HOST_OS} == linux cat ${OPEN_PRU_PATH}/mcu_plus_sdk/source/pru_io/firmware/pru_load_bin_copyright.h pru_i2s_pru0_array.h > ${OPEN_PRU_PATH}/source/pru_i2s/firmware/I2S/pru_i2s_pru0_array.h;"+ 
        "if ${CCS_HOST_OS} == linux rm pru_i2s_pru0_array.h;"+
        "if ${CCS_HOST_OS} == win32  $(CCS_INSTALL_DIR)/utils/cygwin/cat ${OPEN_PRU_PATH}/mcu_plus_sdk/source/pru_io/firmware/pru_load_bin_copyright.h pru_i2s_pru0_array.h > ${OPEN_PRU_PATH}/source/pru_i2s/firmware/I2S/pru_i2s_pru0_array.h;"+ 
