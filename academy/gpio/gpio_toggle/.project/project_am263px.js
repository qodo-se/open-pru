...
const includes_freertos_r5f_am263px_lp = {
    common: [
        ...
        "${OPEN_PRU_PATH}/examples/gpio_toggle/firmware/am263px-lp"
    ],
};
...
const readmeDoxygenPageTag = "EXAMPLES_PRU_GPIO";
...
function getComponentProperty() {
    ...
    property.name = "gpio_pru_io";
    property.isInternal = false;
    property.description = "R5F GPIO PRU IO Project"
