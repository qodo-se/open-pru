...
SECTIONS
{
    ...
    /* PRU I2S Rx ping/pong buffers */
    /* .PruI2s1RxPingPongBuf : {} > 0x48010600 */ /* 32-bit audio words, ICSSM SHMEM */
    .PruI2s1RxPingPongBuf : {} > OCRAM_256K3_RAM

    /* R5F I2S Tx & Rx circular buffers */
    .TxBuf : {} > OCRAM_256K4_RAM, fill = 0xAAAAF0F0
    .RxBuf : {} > OCRAM_256K4_RAM, fill = 0x55555555
    
    /* R5F PRU I2S driver debug capture buffers */
}
...
MEMORY
{
    ...
    /* ICSSM SHMEM */
    ICSSM_SHMEM     : ORIGIN = 0x48010100, LENGTH = 0x00008000-0x100
    /* OCRAM3 - 4 */
    OCRAM_256K3_RAM : ORIGIN = 0x700C0000, LENGTH = 0x00040000
    OCRAM_256K4_RAM : ORIGIN = 0x70100000, LENGTH = 0x00040000
}
