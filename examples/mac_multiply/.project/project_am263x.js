...
const includes_freertos_r5f_am263x_cc = {
    common: [
        ...
        "${OPEN_PRU_PATH}/examples/mac_multiply/firmware/am263x-cc",
    ],
};
...
const includes_freertos_r5f_am263x_lp = {
    common: [
        ...
        "${MCU_PLUS_SDK_PATH}/source/kernel/freertos/config/am263x/r5f",
        "${MCU_PLUS_SDK_PATH}/source/pru_io/driver",
        "${OPEN_PRU_PATH}/examples/mac_multiply/firmware/am263x-lp"
    ],
};
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "pru_io_mac_multiply_main",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "mac_multiply_pru_io";
    property.isInternal = false;
    property.description = "R5F MAC Multiply PRU IO Project"
...
function getComponentBuildProperty(buildOption) {
    ...
    if(buildOption.board=="am263x-cc"){
        build_property.includes = includes_freertos_r5f_am263x_cc;
    }else{
