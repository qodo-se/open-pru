...
const includes_nortos = {
    common: [
        ...
        "${OPEN_PRU_PATH}/examples/pru_emif/pru_emif_app",
        "${OPEN_PRU_PATH}/examples/pru_emif",
        "${OPEN_PRU_PATH}/examples/pru_emif/pru_emif_app/Firmware"
    ],
};
